...
using data_vector = utils::move_vector<node>;
...
struct vector_view {
  ...
  inline vector_view(base_type& base, vector& vec) : _base{base}, _vec{vec} {}
 ...
 private:
  ...
  inline data_vector& _data() const noexcept { return _base._children; }
};
...
struct const_vector_view {
  ...
  inline const_vector_view(const base_type& base, const vector& vec)
      : _base{base}, _vec{vec} {}
 ...
 private:
  ...
  inline const data_vector& _data() const noexcept { return _base._children; }
};
